	...
	<div class="host-header-wrap">
		...
		<nav id="host-nav">
			...
			<c:otherwise>
				...
				<li class="host-nav__item"><a href="">프로모션</a></li>
				<li class="host-nav__item"><a href="">리뷰관리</a></li>
				<li class="host-nav__item"><a href="">예약관리</a></li>
				<li class="host-nav__item"><a href="/host/sales?hostNo=${param.hostNo }&hostingType=${param.hostingType }">매출관리</a></li>
				<li class="host-nav__item"><a class="${menu eq '게스트문의' ? 'active' : '' }" href="/host/chat?hostNo=${param.hostNo }&hostingType=${param.hostingType }">게스트문의</a></li>
				<li class="host-nav__item"><a href="/host/qna?hostNo=${param.hostNo }&hostingType=${param.hostingType }">관리자문의</a></li>
			</ul>
