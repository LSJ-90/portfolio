			...
			<div class="row mb-3 d-flex justify-content-center">
				<div class="col-6 text-center">
					<div class="mb-3">
						...
						<select class="form-control text-center" id="bankName" name="type">
			...
			<div class="row mb-3 d-flex justify-content-center">
				<div class="col-6 text-center">
					<div class="mb-3">
						...
						<input type="text" class="form-control" id="hostName" name="name" value=0/>
					</div>
					<div class="mb-3">
						<label class="form-label">체험 활동 타이틀</label>
						<input type="text" class="form-control" id="actTitle" name="introTitle" value=0/>
					</div>
					<div class="mb-3">
						<label class="form-label">숙박 시설 소개글</label>
						<textarea rows="15" cols="76" name="introContent"></textarea>
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" id="maximumNumber" name="maximumNumber" value=0 />
					</div>
					<div class="mb-3">
						<label class="form-label">1인당 가격</label>
						<input type="text" class="form-control" id="hostAcc" name="pricePerPerson" value="1000"/>
					</div>
					<div class="mb-3">
						<label class="form-label">사진 첨부</label>
						<input type="file" class="form-control" name="image" />
