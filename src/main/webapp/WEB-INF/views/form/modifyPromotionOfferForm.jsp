			...
			<div class="row mb-3 d-flex justify-content-center">
				<div class="col-6 text-center">
					...
					<div>
						...
						<input type="date" value="${promotionOffer.startingDate }" name="startingDate" class="form-control" />
						<label class="form-label">프로모션 종료일</label>
	   					<input type="date" value="${promotionOffer.endingDate }" name="endingDate" class="form-control" />
					</div>
