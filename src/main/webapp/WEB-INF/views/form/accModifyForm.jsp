    ...
    <input type="hidden" name="accNo" value="${accMainDto.accNo }">
      <div class="step-wrap" id="first">
        ...
        <div class="registration-box">
          ...
          <input type="text" class="form-control" id="amenity" name="amenity" value="${accMainDto.bankName}"/>
          <input type="text" class="form-control" id="amenity" name="amenity" value="${accMainDto.accType}"/>
